...
$(document).ready(function () {
      $(".customizer-color li").on('click', function() {
        ...
        $("#color" ).attr("href", `${mybaseurl}/assets/css/`+color+".css" );
